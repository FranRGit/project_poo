 ...
 * @author USUARIO
 */
public class EliminarProfesor extends javax.swing.JDialog {

    /**
     * Creates new form RegistrarAlumno2
     */
    public EliminarProfesor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EliminarProfesor dialog = new EliminarProfesor(new javax.swing.JFrame(), true);
